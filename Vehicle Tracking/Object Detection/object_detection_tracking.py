...
import math
from sort import *
cap=cv2.VideoCapture('../Videos/demo4.mp4')
...
out=cv2.VideoWriter('Output1.avi',cv2.VideoWriter_fourcc('M','J','P','G'),40,(frame_width,frame_height))
